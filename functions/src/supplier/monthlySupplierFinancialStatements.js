    ...
    try {
        ...
        if (!supplierPurchaseSnap.empty) {
            supplierPurchaseSnap.forEach(doc => {
                ...
                if ((startMonth && day.isSameOrAfter(startMonth, "month")) && (endMonth && day.isSameOrBefore(endMonth, "month"))) {
                ...
                } else if (startMonth && day.isSame(startMonth, "month")) {
                    if ("agoLitres" in purchase) {
                        if (purchase.agoLitres) {
                            const detail = purchase.truck;
                            let stationName = purchase.stationName || "";
                ...
                } else if (endMonth && day.isSame(endMonth, "month")) {
                    if ("agoLitres" in purchase) {
                        if (purchase.agoLitres) {
                            const detail = purchase.truck;
                            let stationName = purchase.stationName || "";
