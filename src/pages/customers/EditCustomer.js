...
const EditCustomer = ({ customer }) => {
  ...
  const [balance, setBalance] = useState(customer?.openingBalance);
  ...
  const getPrivateCustomers = async () => {
    let customersArray = [];
    ...
    <div>
      ...
      >
        <Box sx={style} className="rounded-md">
          <div>
            <h3 className="text-center text-xl py-4">Edit Customer Details</h3>
            <div>
