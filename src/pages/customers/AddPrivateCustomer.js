...
import { addPrivateCustomers } from "../../features/customerSlice";
...
const AddPrivateCustomer = () => {
  ...
  return (
    <div>
      <div
        onClick={handleOpen}
        className="h-10 w-60 bg-primaryColor cursor-pointer rounded-xl flex flex-row gap-1 justify-center text-white"
      >
        <Add className="mt-2 py-0.5" />{" "}
        <p className="py-2">Create Private Customer</p>
      </div>
...
export default AddPrivateCustomer;
