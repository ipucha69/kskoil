    ...
    if (!name) {
      ...
      try {
        ...
        await updateDoc(dataRef, {
          ...
          .then(() => {
            toast.success("Pump type is updated successfully");
            getTypes();
            setLoading(false);
          })
          .catch((error) => {
    ...
    <div>
      ...
      >
        <Box sx={style} className="rounded-md">
          <div>
            <h3 className="text-center text-xl py-4">Edit Pump Type</h3>
            <div>
